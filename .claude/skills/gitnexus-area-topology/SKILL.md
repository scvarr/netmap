...
description: "Skill for the Topology area of netmap. 275 symbols across 54 files."
---

# Topology

275 symbols | 54 files | Cohesion: 96%
...
| File | Symbols |
|------|---------|
| `frontend/src/topology/apiSavedMapDataSource.ts` | cableRef, cableRoute, malformed, mapRef, object (+21) |
...
| `frontend/src/topology/apiPhysicalEndpointConnectionWriteDataSource.ts` | isObject, malformed, parsePhysicalEndpointConnectionCreationDocument, readBackendError, requireObject (+5) |
...
| `ApiCableDeleteDataSource` | Class | `frontend/src/topology/apiCableDeleteDataSource.ts` | 4 |
...
| `ApiPhysicalEndpointConnectionWriteDataSource` | Class | `frontend/src/topology/apiPhysicalEndpointConnectionWriteDataSource.ts` | 78 |
| `ApiPhysicalLinkWriteDataSource` | Class | `frontend/src/topology/apiPhysicalLinkWriteDataSource.ts` | 66 |
