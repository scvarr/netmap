...
def test_additive_composed_upgrade_preserves_canonical_identity_for_shared_instance_local_ids():
    ...
    v2 = client.post(f"/v1/library/object-blueprints/{blueprint_id}/versions", json={"body": {"kind": "RECTANGLE", "width": 100, "height": 40}, "composition": {"instances": [{"instance_key": "K", "port_block_version_ref": {"ref_type": "LIBRARY_RECORD", "entity_type": "PortBlockVersion", "entity_id": v2_block_version}, "face": "FRONT", "placement": {"x": .1, "y": .1, "width": .3, "height": .2}}]}, "internal_links": []})
