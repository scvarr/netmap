    ...
    <svg className="cable-routes-foreground" aria-hidden={activeNumericEdit ? undefined : true}>
      ...
      <g className="cable-route-selected-measurements">
        {measurements.map((item) => {
          ...
          const displayedLength = Math.round(item.length);
