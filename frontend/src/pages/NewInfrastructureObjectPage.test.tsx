...
const locationSource = (): LocationDataSource => ({ loadLocations: vi.fn().mockResolvedValue(locations), createLocation: vi.fn(), updateLocation: vi.fn(), reparentLocation: vi.fn(), deleteLocation: vi.fn(), loadPhysicalObjectLocation: vi.fn(), setPhysicalObjectLocation: vi.fn() });
