...
export interface CableNamingInput { cable_label?: string | null; cable_label_template_id?: string | null; generate_cable_label?: boolean; confirmed_historical_label?: string | null }
export interface CableLabelDataSource {
  setCableLabel(cableId: string, label: string | null, confirmedHistoricalLabel?: string | null): Promise<void>;
  generateCableLabel(cableId: string, templateId: string, confirmedHistoricalLabel?: string | null): Promise<void>;
