...
export interface CatalogInventoryCableItem { cable_ref: ProjectionSourceRef; connection_ref: ProjectionSourceRef; label: string; label_source?: 'TECHNICAL_FALLBACK'; resolution: 'RESOLVED'; endpoint_a: CatalogInventoryCableEndpoint; endpoint_b: CatalogInventoryCableEndpoint; gaps: string[]; warnings: string[] }
