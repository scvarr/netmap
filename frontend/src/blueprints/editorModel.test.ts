...
const group = (id: string, keyPrefix: string, kind: 'CONNECTION_POINT' | 'NETWORK_PORT', side: 'LEFT' | 'RIGHT' | 'TOP' | 'BOTTOM', count = 1) => ({ id, keyPrefix, displayPrefix: keyPrefix, kind, side, count, startingNumber: 1 });
