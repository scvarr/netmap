...
Целевые сценарии масштабирования перед L2: рабочая карта 100 объектов — норма,
500 — норма, 500 объектов с 10–25 тыс. отображаемых портов — штатный верхний
диапазон. Значения ниже — **стартовые гипотезы** из performance-аудита: до
прогона PERF-001 они не измерены и не являются обязательствами.
