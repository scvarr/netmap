...
Следующая ветка формализована в [[architecture/graph/02-02-resolver-structures|02.2 Resolver structures]]: какие persistent indexes, view-scoped read models и query-scoped caches нужны каждому resolver.
