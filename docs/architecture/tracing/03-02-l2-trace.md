...
Накладывает на configured topology известное актуальное operational state согласно [[architecture/l2/01-03-02-l2-operational-state|01.3.2 L2 Operational State]].
...
Точная модель MAC/FDB определена в [[architecture/l2/01-03-03-mac-fdb|01.3.3 MAC и FDB]].
