...
Составные логические интерфейсы не требуют специальных классов: базовая зависимость задаётся через `NetworkInterfaceRealization`. Подробности: [[architecture/l1/01-02-network-interface|01.2 NetworkInterface]].
...
Подробности: [[architecture/l2/01-03-l2|01.3 L2 — forwarding model]].
...
Подробности: [[architecture/l3/01-04-l3|01.4 L3 — routing model]].

Выбор routing table, transient local mark и границы `PACKET_MARK -> ROUTING_POLICY -> ROUTE_DECISION` определены отдельно в [[architecture/l3/01-07-policy-routing|01.7 Policy Routing]].
...
Подробности: [[architecture/l3/01-05-security-policy|01.5 Security Policy]].
...
Подробности: [[architecture/l3/01-06-nat|01.6 NAT — packet transformation]].
