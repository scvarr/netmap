...
**Замечание и согласованное направление.** Страницам нужна единая ширина и
отступы, понятная иерархия заголовков и меток разделов, breadcrumbs для
вложенных страниц, согласованное размещение описаний и действий, а также
переиспользуемые примитивы оболочки страницы.
