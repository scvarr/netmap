...
[[09-01-l1-spatial-foundation-plan|09.1 Плане завершения L1 spatial foundation]].
Product/presentation invariants — в [[05-presentation|05. Представление]],
реализованный frontend contract — в [[08-ui-implementation|08. UI implementation contract]].
...
в [[09-01-l1-spatial-foundation-plan|плане L1S]]: control canvas, стабильное
...
зафиксирован в [[05-presentation|presentation contract]].
