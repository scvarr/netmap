...
[[plans/stabilization/10-02-stabilization-backlog|10.2]].
...
- **LOC-001** · MEDIUM · Десятки RU-литералов вне typed i18n-границы на активных
  ...
  смешанный интерфейс. Claim «IMPLEMENTED» в docs/plans/09-01-l1-spatial-foundation-plan скорректирован при
...
- **DOC-001** · LOW · Display-name слота, изменённый в новой версии шаблона,
  ...
  семантику явно в docs/plans/09-01-l1-spatial-foundation-plan (product decision), код не менять до решения.
